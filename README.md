> ** Deprecated: In current versions of Raspberry OS wpa_cli is no longer used, nmcli is used instead. Please use the module [**api-m77-raspberry-wifi-node-nmcli**](https://github.com/mangos77/api-m77-raspberry-wifi-node-nmcli)
___
